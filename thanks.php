...
if(isset($_SESSION["loggedin"]) && $_SESSION['paymentSuccess'] === true && $_SESSION["loggedin"] === true) {
...
<div id="wrapper">
	...
	<div id="header">
		...
		<div class="right marT10">
			...
			<?php if($signnedin === true) :?>
				  	<a href="logout.php?curr_page=thanks" > Logout </a>
				  <?php else :?>
				  	<a href="login.php?curr_page=thanks" >Login</a>
			<?php endif ?>
	...
	<div class="intro left">
	  ...
	  <h3>Your New Balance is $<?php echo $_SESSION['data']['balance']; ?> </h3>
	</div>
	<br class="clear"/>
	<br/>
